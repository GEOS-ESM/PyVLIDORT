...
!  May 2024. Additional flags (Hemispher_Mean, Eddington_flux)
!            Rearranged and regrouped flag output

!  Open output file

      OUTUNIT = 101
      OPEN (OUTUNIT,file = 'TWOSTREAM_WRITE_STD_INPUT.dbg',status = 'replace')
...
!  Write all input to file
      ...
      WRITE(OUTUNIT,DWFL)  'DO_CLASSICAL_PI      = ',DO_CLASSICAL_PI
      ...
      WRITE(OUTUNIT,*)
      WRITE(OUTUNIT,DWFL)  'DO_HEMISPHER_MEAN    = ',DO_HEMISPHER_MEAN
      WRITE(OUTUNIT,DWFL)  'DO_EDDINGTON_FLUX    = ',DO_EDDINGTON_FLUX
      ...
      WRITE(OUTUNIT,*)
      DO LAY=1,NLAYERS
        WRITE(OUTUNIT, '(A,I3,A,1pe24.14)') ' LAY = ',LAY,&
