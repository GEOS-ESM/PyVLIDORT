...
!.............................................................................
  ...
  PUBLIC VLIDORT_Scalar_LandMODIS_pmatrix
  PUBLIC VLIDORT_Vector_LandMODIS_pmatrix
...
!                                                   ! --- Trace Gas Absorption ---
  ...
  !..........................................................................
  subroutine VLIDORT_Vector_LandMODIS_pmom (km, nch, nobs, ngeom, channels, nstreams, plane_parallel, nMom,  &
...
!                                                   ! --- Trace Gas Absorption ---
  ...
  end subroutine VLIDORT_Vector_LandMODIS_pmom


subroutine VLIDORT_Scalar_LandMODIS_pmatrix (km, nch, nobs,channels, nstreams, plane_parallel, nAng, &
                     nPol, InAngles, ROT, depol, alpha, tau, ssa, g, pmatrix, tauI, ssaI, gI, pmatrixI, tauL, ssaL, gL, pmatrixL, &
                     pe, he, te, kernel_wt, param, &
                     solar_zenith, relat_azymuth, sensor_zenith, flux_factor, &
                     MISSING,verbose,radiance_VL_SURF,reflectance_VL_SURF, BR, rc )
  !
...
!                                                   ! --- Trace Gas Absorption ---
  ...
  !                                                   ! --- Aerosol Optical Properties ---
    ...
    real*8, target,   intent(in)  :: ssaI(km,nch,nobs) ! ice cloud single scattering albedo    
    real*8, target,   intent(in)  :: gI(km,nch,nobs)   ! ice cloud asymmetry factor
    real*8, target,   intent(in)  :: pmatrixI(km,nch,nobs,nAng,nPol) !components of the scat phase matrix


    real*8, target,   intent(in)  :: tauL(km,nch,nobs) ! liquid cloud optical depth
    real*8, target,   intent(in)  :: ssaL(km,nch,nobs) ! liquid cloud single scattering albedo  
    real*8, target,   intent(in)  :: gL(km,nch,nobs)   ! liquid cloud asymmetry factor
    real*8, target,   intent(in)  :: pmatrixL(km,nch,nobs,nAng,nPol) !components of the scat phase matrix
  ...
  end subroutine VLIDORT_Scalar_LandMODIS_pmatrix
